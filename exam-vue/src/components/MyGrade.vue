  ...
  <el-container
    ...
    <el-header height="210">
      ...
      <el-select @change="operation" clearable v-model="queryInfo.examId"
                 placeholder="请选择考试" style="margin-bottom: 10px;">
      ...
      <el-table
        ...
        <el-table-column align="center" label="总得分">
          <template slot-scope="scope">
            <span style="color: #1f90ff" v-if="scope.row.totalScore">{{ scope.row.totalScore }}</span>
            <span style="color: orangered" v-else>未批改</span>
          </template>
        </el-table-column>
