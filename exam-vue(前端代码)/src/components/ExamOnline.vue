  ...
  <el-container>
    ...
    <el-main>
      ...
      <el-table
        ...
        <el-table-column align="center" prop="totalScore" label="试卷总分"></el-table-column>

        <el-table-column align="center" prop="passScore" label="及格分数"></el-table-column>

        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <el-button round size="small" :disabled="!checkExam(scope.row)" @click="toStartExam(scope.row)"
...
<!--        <br>-->
    ...
    <el-button round type="warning" @click="startExamDialog = false">返 回</el-button>
    <el-button round type="primary" @click="$router.push('/exam/'+ currentSelectedExam.examId)">开始考试</el-button>
  </span>
    </el-dialog>
  </el-container>
</template>
