<template>
  <el-container>
    ...
    <el-header height="220">
      ...
      <el-row>
        <el-button round type="primary" icon="el-icon-plus" @click="addQuTableVisible = true">添加</el-button>
      </el-row>
    </el-header>
    ...
    <el-main>
      ...
      <el-table
        ...
        <el-table-column align="center"
                         label="难度">
          <template slot-scope="scope">
            <el-tag effect="dark" type="success" v-if="scope.row.level === 1">简单</el-tag>
            <el-tag effect="dark" type="primary" v-else-if="scope.row.level === 2">中等</el-tag>
        ...
        <el-table-column align="center"
                         label="操作">
          <template slot-scope="scope">
            <el-button round size="mini" type="warning" icon="el-icon-edit" @click="updateQu(scope.row.id)">编辑</el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog title="更新题目" :visible.sync="updateQuTableVisible" width="50%" center>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button round @click="updateQuTableVisible = false">取 消</el-button>
        <el-button round type="primary" @click="updateQuestion">确 定</el-button>
      </div>
    </el-dialog>
