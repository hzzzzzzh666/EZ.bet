<template>
  <el-container>
    <el-header height="150">
      <el-button icon="el-icon-top-left" @click="$router.push('/examOnline')" type="text" size="medium">返回列表</el-button>
    ...
    <el-main style="display: flex; flex-wrap: wrap; column-gap: 20px; justify-content: space-around">
<!--      <el-card>-->
        <!--题目信息-->
        <div v-for="(item,index) in questionInfo" :key="index" style="margin-top: 15px; width: 450px">
          <div>
