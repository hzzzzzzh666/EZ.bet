<template>
  <el-container>
    ...
    <el-main style="display: grid; flex-wrap: wrap; column-gap: 20px">
<!--      <el-card>-->
        <!--题目信息-->
        <div v-for="(item,index) in questionInfo" :key="index" style="margin-top: 15px; border-radius: 10px; padding: 10px; border: 1px solid #1f90ff">
          <div>
...
<!--      </el-card>-->
      <el-button round style=" width: 100px;margin-top: 25px" type="primary" @click="uploadMarkExam">提交阅卷</el-button>
    </el-main>
