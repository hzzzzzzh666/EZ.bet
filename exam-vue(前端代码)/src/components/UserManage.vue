<template>
  <el-container>
    ...
    <el-dialog :title="formTitle"  :visible.sync="addTableVisible" width="30%" @close="resetAddForm"
               center>
      ...
      <el-form :model="addForm" label-position="top" :rules="addFormRules" ref="addForm">
        ...
        <el-form-item label="密码" label-width="120px" prop="password" v-if="formType === 'add'">
